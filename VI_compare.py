...
def compare_vi(VI_dir,VI_file,VI_truth_file,output_dir):
  ...
  m = pd.read_csv(VI_truth_file) #merged file or file you want to compare to
...
VI_truth_file  = VI_dir+'output/desi-vi_SV0_QSO_tile68002_night20200315_1_merged.csv'
...
# If you don't want to compare everytihng define a single file here. 
VI_file    = 'desi-vi_SV0_QSO_tile68002_night20200315_1_TMD.csv'  # We add .csv to read in this file, and e.g. _z.png to print plots for this file
